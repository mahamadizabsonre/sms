											...
											<table class="table table-striped table-bordered dt-responsive nowrap " id="dataTable-exemple"
												...
												<thead>
													<tr role="row">
														<th class="sorting_asc" tabindex="0"
															...
															style="width: 203px;">
															<fmt:message key="common.nom"/>
														</th>
														<th class="sorting" tabindex="0" aria-controls="dataTable"
															rowspan="1" colspan="1"
															aria-label="Position: activate to sort column ascending"
															style="width: 311px;">
															<fmt:message key="common.prenom"/>
														</th>
														<th class="sorting" tabindex="0" aria-controls="dataTable"
															rowspan="1" colspan="1"
															aria-label="Office: activate to sort column ascending"
															style="width: 151px;">
															<fmt:message key="common.adresse"/>
														</th>
														<th class="sorting" tabindex="0" aria-controls="dataTable"
															rowspan="1" colspan="1"
												...
												<tfoot>
													<tr>
														...
														<th rowspan="1" colspan="1"><fmt:message key="common.adresse"/></th>
														<th rowspan="1" colspan="1"><fmt:message key="common.mail"/></th>
														<th rowspan="1" colspan="1"><fmt:message key="common.fournisseur.commande"/></th>
												...
												<tbody>
													<c:forEach items="${fournisseurs }" var="fournisseur">
														<tr role="row" class="odd">
															<td class="sorting_1 text-center">${fournisseur.getNom() }</td>
															<td class="text-center">${fournisseur.getPrenom() }</td>
															<td class="text-center">${fournisseur.getAdresse() }</td>
															<td class="text-center">${fournisseur.getMail() }</td>
															<td class="text-center"></td>
															<td class="text-center"><img alt="photo-client" src="${fournisseur.getPhoto() }" width="50px" height="50px"></td>
															<td> 
																...
																&nbsp;|&nbsp;
																<a href="javascript:void(0)" title="Supprimer" data-toggle="modal" data-target="#modalFournisseur${fournisseur.getIdFournisseur() }">
																	<i class="fa fa-trash">&nbsp;</i>
																</a>
																<!-- Modal Start -->
																<div class="modal fade" id="modalFournisseur${fournisseur.getIdFournisseur() }" tabindex="-1" 
																	role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
																  <div class="modal-dialog" role="document">
																    <div class="modal-content">
																      <div class="modal-header">
																        <h5 class="modal-title" id="exampleModalLabel">
																        	<fmt:message key="common.modal.title.delete.fournisseur"/>
																        </h5>
