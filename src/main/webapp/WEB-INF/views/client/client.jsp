												...
												<tbody>
													<c:forEach items="${clients }" var="client">
														<tr role="row" class="odd">
															<td class="sorting_1 text-center">${client.getNom() }</td>
															<td class="text-center">${client.getPrenom() }</td>
															<td class="text-center">${client.getAdresse() }</td>
															<td class="text-center">${client.getMail() }</td>
															<td class="text-center"><img alt="photo-client" src="${client.getPhoto() }" width="50px" height="50px"></td>
															<td> 
																...
																&nbsp;|&nbsp;
																<a href="javascript:void(0)" title="Supprimer" data-toggle="modal" data-target="#modalClient${client.getIdClient() }">
																    ...
																    <div class="modal-content">
																      <div class="modal-header">
																        <h5 class="modal-title" id="exampleModalLabel">
																        	<fmt:message key="common.modal.title.delete.client"/>
																        </h5>
