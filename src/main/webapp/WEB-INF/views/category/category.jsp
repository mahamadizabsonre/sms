									...
									<div class="row">
										...
										<!--table table-bordered dataTable  -->
											<table class="table table-striped table-bordered dt-responsive nowrap " id="dataTable-exemple"
												...
												<tfoot>
													<tr>
														<th rowspan="1" colspan="1"><fmt:message key="common.code"/></th>
												...
												<tbody>
													<c:forEach items="${categories }" var="category">
														<tr role="row" class="odd">
															<td class="sorting_1 text-center">${category.getCode() }</td>
															<td class="text-center">${category.getDesignation() }</td>
															<td> 
																...
																&nbsp;|&nbsp;
																<a href="javascript:void(0)" title="Supprimer" data-toggle="modal" data-target="#modalCategory${category.getIdCategory() }">
																	<i class="fa fa-trash">&nbsp;</i>
																</a>
																<!-- Modal Start -->
																<div class="modal fade" id="modalCategory${category.getIdCategory() }" tabindex="-1" 
																	role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
																  <div class="modal-dialog" role="document">
																    <div class="modal-content">
																      <div class="modal-header">
																        <h5 class="modal-title" id="exampleModalLabel">
																        	<fmt:message key="common.modal.title.delete.category"/>
																        </h5>
																      ...
																      <div class="modal-footer">
																        ...
																        <c:url value="/category/supprimer/${category.getIdCategory() }" var="urlSuppression"/>
